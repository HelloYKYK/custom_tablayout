...
import static android.support.design.R.*;
import static android.support.design.R.style.Widget_Design_TabLayout;
import static android.support.design.R.styleable.*;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, TabLayout,
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        private  float getTabTextWidth(){
            if (mTextView!=null){
                TextPaint paint =  mTextView.getPaint();
                //文字左右平分距left和right的宽度
                return paint.measureText(mTextView.getText().toString());
            }
            return  0;
        }
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(layout.design_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
